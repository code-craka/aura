...
exports.AuraSecurityFramework = void 0;
const events_1 = require("events");
class AuraSecurityFramework extends events_1.EventEmitter {
    constructor() {
        super();
     ...
     */
    validatePermission(sandboxId, permission) {
     ...
     */
    async filterPrivacyData(content) {
        const sensitiveData = [];
     ...
     */
    async monitorNetworkRequest(url, method) {
    ...
    calculateThreatConfidence(match, content) {
...
exports.AuraSecurityFramework = AuraSecurityFramework;
